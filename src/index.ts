            ...
            await linePush(env.LINE_ACCESS_TOKEN, uid, [
              {
                ...
                text: [
                  ...
                  prebookUrl,
                  '',
                  'กดลิงก์แล้วกรอกฟอร์มได้เลย ระบบจะเชื่อม LINE ให้อัตโนมัติ ไม่ต้องพิมพ์รหัสอะไรเพิ่ม',
                  'เมื่อมีห้องว่างตรงกับที่แจ้งไว้ ทีมงานจะทักกลับไปหาคุณใน LINE เองครับ'
                ].join('\n')
              }
            ]).catch(console.error);
